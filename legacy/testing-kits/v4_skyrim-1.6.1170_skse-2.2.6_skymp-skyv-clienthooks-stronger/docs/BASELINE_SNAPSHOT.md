...
This document records the exact versions, paths, and settings used for a known-good local run where:
...
- Repo root: `C:\Users\t\Documents\Github\FiveE\`
- SkyMP upstream clone: `C:\Users\t\Documents\Github\FiveE\external\skymp\`
- SkyMP SR clone: `C:\Users\t\Documents\Github\FiveE\external\skymp-sr\`
...
- Server folder: `C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\server\`
- Client folder (Data payload): `C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\client\Data\`
...
File: `external\skymp\build\dist\server\server-settings.json`
