...
### 2.1 Known-good local paths

- Skyrim root: `C:\Program Files (x86)\Steam\steamapps\common\Skyrim Special Edition\`
- SkyMP server folder: `C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\server\`
- SkyMP client folder: `C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\client\Data\`
