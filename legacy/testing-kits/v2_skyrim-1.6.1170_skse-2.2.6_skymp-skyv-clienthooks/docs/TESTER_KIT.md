...
- `client/Data/` — the SkyMP client `Data` payload (copied from `external\skymp\build\dist\client\Data\`)
- `docs/` — include:
...
PowerShell example (creates a local staging folder):

```powershell
$kitRoot = "C:\Users\t\Documents\Github\FiveE\staging\fivee-tester-kit"
$clientSrc = "C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\client\Data"
$docsSrc = "C:\Users\t\Documents\Github\FiveE\FiveE\docs"
...
```powershell
$zipPath = "C:\Users\t\Documents\Github\FiveE\staging\fivee-tester-kit.zip"
