...
- Repo checkout: `C:\Users\t\Documents\Github\FiveE\external\skymp`
- Skyrim install: `C:\Program Files (x86)\Steam\steamapps\common\Skyrim Special Edition\`
...
```powershell
cd "C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\server"
```
...
```powershell
$src = "C:\Program Files (x86)\Steam\steamapps\common\Skyrim Special Edition\Data"
$dst = "C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\server\data"
...
- Source: `C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\client\Data\`
- Destination: `C:\Program Files (x86)\Steam\steamapps\common\Skyrim Special Edition\Data\`

If you prefer command line (Admin PowerShell recommended):

```powershell
$src = "C:\Users\t\Documents\Github\FiveE\external\skymp\build\dist\client\Data"
$dst = "C:\Program Files (x86)\Steam\steamapps\common\Skyrim Special Edition\Data"
...
If you run commands from `C:\Users\t\Documents\Github\FiveE\` (repo root), relative paths like `./dist_back/...` won’t work.
