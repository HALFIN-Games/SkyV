...
This version adds a RaceMenu loading overlay and fully strips the preview model before equipping ragged robes/boots.

Changes vs v7:

- Overlay uses a percent-based progress bar (0-100%) instead of an infinite loop.
- Overlay has more reliable hide logic so it cannot get stuck.
